...
public sealed class BranchWithLocalPayloadBuilder<TRequest, TPayload, TLocalPayload, TSuccess, TError>
{
	...
	internal BranchWithLocalPayloadBuilder(BranchWithLocalPayload<TPayload, TLocalPayload, TError> branch)
	{
		_branch = branch;
	}
	...
	public BranchWithLocalPayloadBuilder<TRequest, TPayload, TLocalPayload, TSuccess, TError> DoAll(
		params Func<TPayload, TLocalPayload, CancellationToken, Task<Either<TError, (TPayload MainPayload, TLocalPayload LocalPayload)>>>[]
			activities)
	{
