...
/// <summary>
/// Represents a builder for a railway that processes a request and
...
public class RailwayBuilder<TRequest, TPayload, TSuccess, TError>
{
	...
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Validate(
	...
	/// <param name="validation">The validation function</param>
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Validate(Func<TRequest, Option<TError>> validation)
	{
		_validations.Add(
			new((
					request,
	...
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Guard(
	...
	/// <param name="guard">The guard function that returns Either an error or Unit</param>
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Guard(Func<TRequest, Either<TError, Unit>> guard)
	{
		_guards.Add(
			new((
					request,
	...
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> DoAll(
	...
	/// <param name="activities">The activity functions</param>
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> DoAll(params Func<TPayload, Either<TError, TPayload>>[] activities)
	{
		foreach (var activity in activities)
		{
			_activities.Add(
	...
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> DoIf(
	...
	/// <summary>
	/// Creates a branch in the railway that will only execute if the condition is true.
	/// </summary>
	/// <param name="condition">The condition to evaluate</param>
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	[Obsolete("Use Group() method instead. This method will be removed in a future version.")]
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Branch(
		Func<TPayload, bool> condition,
	...
	/// <summary>
	/// Creates an unconditional branch in the railway. (Always executes)
	/// </summary>
	/// <param name="branchConfiguration">An action that configures the branch</param>
	/// <returns>The railway builder to continue the railway definition</returns>
	[Obsolete("Use Group() method instead. This method will be removed in a future version.")]
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Group(
		Func<TPayload, bool>? condition,
	...
	/// <summary>
	/// Creates a branch in the railway with a local payload that will only execute if the condition is true.
	/// </summary>
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	[Obsolete("Use WithContext() method instead. This method will be removed in a future version.")]
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> BranchWithLocalPayload<TLocalPayload>(
		Func<TPayload, bool> condition,
		Func<TPayload, TLocalPayload> localPayloadFactory,
	...
	/// <summary>
	/// Creates a branch in the railway with a local payload that always executes.
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> WithContext<TLocalState>(
		Func<TPayload, bool>? condition,
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Detach(
		Func<TPayload, bool>? condition,
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Parallel(
		Func<TPayload, bool>? condition,
	...
	/// <returns>The railway builder to continue the railway definition</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> ParallelDetached(
		Func<TPayload, bool>? condition,
	...
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Finally(
		Func<TPayload, CancellationToken, Task<Either<TError, TPayload>>> activity)
	{
	...
	/// <param name="activity">The activity to execute</param>
	/// <returns>The builder instance for method chaining</returns>
	public RailwayBuilder<TRequest, TPayload, TSuccess, TError> Finally(Func<TPayload, Either<TError, TPayload>> activity)
	{
	...
	/// <summary>
	/// Executes the railway: runs validations, activities, conditional logic, branches, features, and finally actions.
	/// </summary>
	/// <param name="request">The railway request input.</param>
	...
	/// </param>
	/// <param name="payload">The main railway payload.</param>
	/// <param name="cancellationToken">Token to observe for cancellation.</param>
	/// <returns>
