...
/// <summary>
/// Base marker interface for all railway validations
/// </summary>
public interface IRailwayValidation;
...
public interface IRailwayValidation<in TRequest, TError> : IRailwayValidation
{
	/// <summary>
